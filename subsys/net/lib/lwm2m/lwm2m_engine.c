...
static int do_send_op(struct lwm2m_message *msg, uint16_t content_format, struct lwm2m_obj_path path_list[], uint8_t path_list_size)
{
	switch (content_format) {
#if defined(CONFIG_LWM2M_RW_SENML_JSON_SUPPORT)
	case LWM2M_FORMAT_APP_SEML_JSON:
